...
fun SignUpScreen(navController: NavController, viewModel: SignUpViewModel = hiltViewModel()) {
    ...
    when(uiState.value) {
        ...
        is SignUpViewModel.SignUpEvent.Cancelled -> {
            loading.value = false
        }
    ...
    Box(modifier = Modifier.fillMaxSize()) {
            ...
            horizontalAlignment = Alignment.CenterHorizontally)
        {
            ...
            FoodHubTextField(
                ...
                label = {
                    Text(text = stringResource(R.string.name), color = Color.DarkGray)
                }
            )
                ...
                Box {
                    AnimatedContent(
                        ...
                        if (target) {
                            ...
                            Text(text = stringResource(id = R.string.sign_up), fontSize = 18.sp, fontFamily = poppinsFontFamily, color = AppWhite)
                        }
                    }
                }
            }
